...
def track_patch_lifecycle(
    patch, event: str, metadata: Dict[str, Any] = None, emit_update: bool = False
):
...
def get_attribution_stats(days: int = 30) -> Dict[str, Any]:
    ...
    return {
        "by_origin": {
            "llm_generation": {
                "count": 10,
                "total_reward_delta": 1.5,
                "avg_reward_delta": 0.15,
            },
            "mutation": {
                "count": 5,
                "total_reward_delta": 0.5,
                "avg_reward_delta": 0.10,
            },
        },
        "by_area": {
            "prompts": {
                "count": 8,
                "total_reward_delta": 1.2,
                "avg_reward_delta": 0.15,
            },
            "bandit": {"count": 4, "total_reward_delta": 0.4, "avg_reward_delta": 0.10},
            "ui_metrics": {
                "count": 3,
                "total_reward_delta": 0.3,
                "avg_reward_delta": 0.10,
            },
        },
        "total_commits": 15,
